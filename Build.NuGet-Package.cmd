...
"%NUNIT_CONSOLE%" "%OUT_DIR%\Tests\Omnifactotum.Wpf.Tests.dll" /basepath="%OUT_DIR%\Tests" /work="%OUT_DIR%\Tests" /labels /stoponerror /noshadow || goto ERROR
echo * Running automated tests - DONE.


if "%SIGN_OMNIFACTOTUM_WPF%" neq "1" (
    echo.
