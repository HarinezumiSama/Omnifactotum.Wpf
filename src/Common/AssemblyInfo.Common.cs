...
#if !WINDOWS && NETCOREAPP && !NETCOREAPP1_0_OR_GREATER
...
#if NET5_0 && (!NETCOREAPP3_0_OR_GREATER || !NETCOREAPP3_1_OR_GREATER || !NET5_0_OR_GREATER)
#error [NET5_0] The compiler does not support `NET*_OR_GREATER` preprocessor symbols required to compile this project.
#endif

#if NET6_0 && (!NETCOREAPP3_0_OR_GREATER || !NETCOREAPP3_1_OR_GREATER || !NET5_0_OR_GREATER || !NET6_0_OR_GREATER)
#error [NET6_0] The compiler does not support `NET*_OR_GREATER` preprocessor symbols required to compile this project.
#endif

#if NET7_0 && (!NETCOREAPP3_0_OR_GREATER || !NETCOREAPP3_1_OR_GREATER || !NET5_0_OR_GREATER || !NET6_0_OR_GREATER || !NET7_0_OR_GREATER)
